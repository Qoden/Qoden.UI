...
namespace Qoden.UI
{
    ...
    public class QodenView : PlatformViewGroup, ILayoutable
    {
        ...
        public sealed override void LayoutSubviews()
        {
            ...
            //Root view receive system defined padding which impossible to override.
            //
            if (!(Superview is UIWindow))
            {
                layoutBuilder.Padding = new EdgeInsets((float)LayoutMargins.Left,
                                                       (float)LayoutMargins.Top,
                                                       (float)LayoutMargins.Right,
                                                       (float)LayoutMargins.Bottom);
            }
